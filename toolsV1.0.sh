...
echo "\033[1;1;31m__________________________________________________"
echo ""
echo "\033[34;1m Tanggal:" date +"%d-%m-%y"
echo ""
echo $blue"----------[OTHERS]----------"
...
echo $red"-----------------------------"
echo $cyan"42).Install metasploit 2"
echo $red"-----------------------------"
echo $cyan"43).Install recondog"
echo $red"-----------------------------"
echo $cyan"44).Install katoolin"
echo $red"-----------------------------"
echo $cyan"45).Install d-tect"
echo ""
...
apt install python2
apt install git
git clone https://github.com/UltimateHackers/HashBuster
cd Hash-Buster
python2 hash.py
fi
